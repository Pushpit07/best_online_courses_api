...
//routes
router.post('/link', linkCreateValidator, runValidation, requireSignin, authMiddleware, create);  //creating
router.post('/links', requireSignin, adminMiddleware, list);  //to get a single category
