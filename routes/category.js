...
//routes
router.post('/category', categoryCreateValidator, runValidation, requireSignin, adminMiddleware, create);  //creating
router.get('/categories', list);  //to get a single category
